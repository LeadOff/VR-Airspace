...
/**
 * Created by gregou on 12/03/2017.
 */
import android.content.Context;
...
public class MynewRenderer implements GLSurfaceView.Renderer {
    public MynewRenderer(currentprogress currentprogress) {}
    ...
    public MynewRenderer(Context context) {
        mContext = context;
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        gl.glMultMatrixf(currentprogress.mR, 0);
        //gl.glRotatef(mAngleX-currentprogress.x, 1, 0, 0);
        //gl.glRotatef(mAngleY-currentprogress.y, 0, 1, 0);
       // gl.glRotatef(mAngleZ-currentprogress.z, 0, 0, 1);
